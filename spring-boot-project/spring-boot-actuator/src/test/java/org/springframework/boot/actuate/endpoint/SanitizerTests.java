...
class SanitizerTests {
	...
	private static Stream<String> matchingUriUserInfoKeys() {
		return Stream.of("uri", "my.uri", "myuri", "uris", "uris[0]", "my.uris", "my.uris[10]", "myuris", "myuris[1]",
				"address", "my.address", "myaddress", "myaddress[0]", "addresses", "addresses[2]", "my.addresses",
				"my.addresses[11]", "myaddresses", "myaddresses[0]");
	}
